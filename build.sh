...
-Wmissing-include-dirs -Wjump-misses-init -Wlogical-op -I../include -I. -I.. \
-O2 -flto -flto-partition=one -fwhole-program -pthread -DNDEBUG ./*.c \
../main.c -o "$output" "$@" -lwolfssl && strip "$output")
